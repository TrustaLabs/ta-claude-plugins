...
description: 当用户处于plan模式时或要求"制定实现计划"、"创建开发计划"、"分析需求"、"设计实现方案"、"评估技术方案"、"优化计划"、"完善方案"、"交互式制定计划"或需要通过迭代细化创建详细实施计划时，应使用此 skill。提供结构化的多轮对话以进行全面的计划开发。使用5层次框架深度挖掘需求，MoSCoW矩阵防止跑偏，4维度边界情况矩阵系统化处理边界情况。
version: 0.2.0
---
