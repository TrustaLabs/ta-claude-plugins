...
description: 当用户在plan模式规划任务时或需要创建详细实施计划时，应使用此 skill。提供结构化的多轮对话以进行全面的计划开发。使用5层次框架深度挖掘需求，MoSCoW矩阵防止跑偏，4维度边界情况矩阵系统化处理边界情况。触发短语包括："帮我制定计划"、"分步骤实现"、"把这个任务拆解一下"、"我需要做多件事"、"规划一下实现步骤"、"分析需求"、"设计实现方案"、"评估技术方案"、"优化计划"、"完善方案"、"交互式制定计划"。
version: 0.2.0
---
...
**核心原则：** 提高每轮信息密度，减少反复对话，使用 AskUserQuestion 工具一次性提出多个结构化问题。

---

#### 第1轮：需求全貌挖掘（15-20分钟）

使用**5层次框架**系统化地深度澄清需求，通过 AskUserQuestion 工具一次性提出2-3个结构化问题：
